    ...
    <div class="mt-8">
      <div class="flex">
        <h2 class="text-3xl text-indigo-500 font-bold">
          المنتجات /<span class="text-gray-700"> تعديل</span>
        </h2>
      </div>
      ...
      <base-panel class="mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                @change="getSubcategoreis(form.category_id)"
                name="category_id"
            ...
            <div>
              ...
              <span
                class="text-red-500 text-xs mt-4"
                v-if="$page.errors.subcategory_id"
                >{{ $page.errors.subcategory_id[0] }}
              </span>
            </div>
            <div>
              <base-input
            ...
            <div>
              <base-input
                ...
                name="deducted_value"
                v-model="form.deducted_value"
                :error="$page.errors.deducted_value"
                required
              >
              </base-input>
            </div>
            ...
            <div>
              ...
              />
              <span class="text-red-500 text-xs mt-4" v-if="$page.errors.image"
                >{{ $page.errors.image[0] }}
              </span>
            </div>
          </div>
        ...
        <div class="flex justify-start mt-4">
          <base-button danger @click="deleteProduct">حذف المنتج</base-button>
        </div>
      </base-panel>
    </div>
...
export default {
  ...
  props: ["product", "categories", "_subcategories","image"],
  data() {
    return {
      form: {
        id: "",
  ...
  methods: {
    ...
    getSubcategoreis(id) {
      axios
        .get("/dashboard/get/subcategories/" + id)
        .then((res) => {
          console.log(res);
