    ...
    <div class="mt-8">
      <div class="flex">
        <h2 class="text-3xl text-indigo-500 font-bold">
          المستخدمين /<span class="text-gray-700"> تعديل</span>
        </h2>
      </div>
      ...
      <base-panel class="mt-4">
        ...
        <div class="flex justify-start mt-4">
          <base-button danger @click="deleteUser">حذف المستخدم</base-button>
        </div>
      </base-panel>
    </div>
  </layout>
...
export default {
  ...
  methods: {
    ...
    deleteUser() {
      this.$inertia.delete(
        this.$route("users.destroy", this.user.id),
        this.form
      );
    },
  },
