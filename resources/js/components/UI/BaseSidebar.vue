    ...
    <div class="px-2 py-6 md:block" :class="isOpen ? 'block' : 'hidden'">
      <ul>
        ...
        <li
          ...
          class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
          :class="[
            route().current('categories.*') ? 'bg-gray-900' : '',
            route().current('subcategories.*') ? 'bg-gray-900' : '',
          ]"
        >
          <a class="flex items-center cursor-pointer">
            ...
            <svg
              v-if="!categoryIsOpen"
              class="fill-current w-3 text-gray-500"
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li
          class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
          :class="route().current('customer.*') ? 'bg-gray-900' : ''"
        >
          <a href="/dashboard/customer/services" class="flex items-center">
            <svg
              viewBox="0 0 20 20"
              fill="currentColor"
              class="phone text-gray-500 w-6 h-6"
            >
              <path
        ...
        <li
          class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
          :class="route().current('deliveries.*') ? 'bg-gray-900' : ''"
        >
